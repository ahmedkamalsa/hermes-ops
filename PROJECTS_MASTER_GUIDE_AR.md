...
- ?? ????? ?????? ???????? ?? ???? ?????? ??? Netlify ?? ?????? ?????? `D:\foraj_social\287\vs\site`.
- ?? ????? ???? ??????? ???????? ?? ?????? ??? ????? ???????? `0-9` ??? ??????? ???????/????????.
- ?? ????? ?????? ??????? ???? ?????? ?????? ??? `??? ????` ?`???` ???????? ???????/?????.
- ?? ?????? ?????? ?????? ??? Playwright:
  - ???????: `313`
  ...
  - ?? ???? ????? mojibake ?? ???? ???????.
  - ??? ??????? ????: `????? ??? ????` ?`?????? ?????: ???` ???? ????.
- ?? ????? ??? Netlify ??? API ??? Netlify CLI ???? ?????? ???? ????? npm lock.
- Netlify deploy id: `6aaaec8b8191387210dca7e5`.
- ???? Netlify API: `ready`.
- ??????: `https://alforaijboard.netlify.app/?v=6aaaec8b8191387210dca7e5`.
- ?????? ????: ??? ?????? ???? ?? ???? Playwright ????? ????? ?????? ??? ??? artifact ?????? ?????? ????? ?Netlify ??? ?????? ?????.
